...
public class CSVParserTest {
    ...
    @Test
    public void parseSimpleStringWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
        String[] nextLine = csvParser.parseLine("a,b,c");
        assertEquals(3, nextLine.length);
        assertEquals("a", nextLine[0]);
    ...
    @Test
    public void parseSimpleQuotedStringWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
        String[] nextLine = csvParser.parseLine("\"a\",\"b\",\"c\"");
        assertEquals(3, nextLine.length);
        assertEquals("\"a\"", nextLine[0]);
    ...
    @Test
    public void parseSimpleQuotedStringWithSpacesWithRetainQuotes() throws IOException {
    ...
    public void parseQuotedStringWithDefinedSeperatorWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withSeparator(':').
            withRetainQuoteChars(true).build();
    ...
    @Test
    public void parseMultiLinedQuotedWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
        String[] nextLine = csvParser.parseLine("a,\"PO Box 123,\nKippax,ACT. 2615.\nAustralia\",d.\n");
        assertEquals(3, nextLine.length);
        assertEquals("a", nextLine[0]);
    ...
    @Test
    public void parseQuotedQuoteCharactersWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
        String[] nextLine = csvParser.parseLineMulti("\"Glen \"\"The Man\"\" Smith\",Athlete,Developer\n");
        assertEquals(3, nextLine.length);
        assertEquals("\"Glen \"\"The Man\"\" Smith\"", nextLine[0]);
    ...
    @Test
    public void testStrictQuoteWithGarbageWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().
            withSeparator(',').
            withQuoteChar('\"').
            withEscapeChar('\\').
    ...
    @Test
    public void testCanIgnoreQuotationsWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().
            withSeparator(CSVParser.DEFAULT_SEPARATOR).
            withQuoteChar(CSVParser.DEFAULT_QUOTE_CHARACTER).
            withEscapeChar(CSVParser.DEFAULT_ESCAPE_CHARACTER).
    ...
    @Test
    public void testIssue3314579WithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().
            withSeparator(';').
            withQuoteChar(CSVParser.DEFAULT_QUOTE_CHARACTER).
            withEscapeChar(CSVParser.DEFAULT_ESCAPE_CHARACTER).
    ...
    @Test
    public void testIssue2263439WithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().
            withSeparator(',').
            withQuoteChar('\'').
            withRetainQuoteChars(true).
    ...
    @Test
    public void testIssue2726363WithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
    ...
    @Test(expected = IOException.class)
    public void anIOExceptionThrownifStringEndsInsideAQuotedStringWithRetainQuotes() throws IOException {
       csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
       csvParser.parseLine("This,is a \"bad line to parse.");
    }
    ...
    @Test
    public void parseLineMultiAllowsQuotesAcrossMultipleLinesWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
        String[] nextLine = csvParser.parseLineMulti("This,\"is a \"good\" line\\\\ to parse");
    ...
    @Test
    public void pendingIsClearedAfterCallToParseLineWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
        String[] nextLine = csvParser.parseLineMulti("This,\"is a \"good\" line\\\\ to parse");
    ...
    @Test
    public void returnPendingIfNullIsPassedIntoParseLineMultiWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
        String[] nextLine = csvParser.parseLineMulti("This,\"is a \"goo\\d\" line\\\\ to parse\\");
    ...
    @Test
    public void returnNullWhenNullPassedInWithRetainQuotes() throws IOException {
        csvParser = new CSVParserBuilder().withRetainQuoteChars(true).build();
        String[] nextLine = csvParser.parseLine(null);
        assertNull(nextLine);
    }
    ...
    @Test
    public void testIssue2958242WithoutQuotesWithRetainQuotes() throws IOException {
        CSVParser testParser = new CSVParserBuilder().
            withSeparator('\t').
            withRetainQuoteChars(true).
            build();
